...
static void MX_GPIO_Init(void)
{
  ...
  GPIO_InitStruct.Pin = IR_CH1_Pin|IR_CH2_Pin|IR_CH3_Pin|IR_CH4_Pin;
  ...
  /*Configure GPIO pin : IR_CH5_Pin */
  GPIO_InitStruct.Pin = IR_CH5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(IR_CH5_GPIO_Port, &GPIO_InitStruct);
